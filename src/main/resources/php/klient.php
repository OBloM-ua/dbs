...
<div>
    <form id='searchform' action='klient.php' method='get'>
...
<div>
    <form id='insertform' action='klient.php' method='get'>
        Neue Klient einfuegen:
        <table style='border: 1px solid #DDDDDD'>
            ...
            <tr>
                ...
                <td>
                    <input id='ADRESSE' name='ADRESSE' type='text' size='20'
...
if (isset($_GET['EMAIL'])) {
    ...
    $sql = "INSERT INTO KLIENT VALUES('" . $_GET['EMAIL'] . "','" . $_GET['PASSWORD'] . "','" . $_GET['NAME'] . "', '" . $_GET['ADRESSE'] . "') ";
...
if (isset($_GET['search'])) {
    $sql = "SELECT * FROM Klient WHERE name like '%" . $_GET['search'] . "%'";
} else {
